...
local hash = loadstring(downloadFile('vapeskid/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('vapeskid/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('vapeskid/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('vapeskid/profiles/whitelist.json') and readfile('vapeskid/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('vapeskid/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('vapeskid/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('vapeskid/assets/new/radaricon.png'),
