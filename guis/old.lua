...
local getcustomassets = {
	['vapeskid/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['vapeskid/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['vapeskid/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['vapeskid/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['vapeskid/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['vapeskid/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['vapeskid/assets/old/info.png'] = 'rbxasset://info.png',
	['vapeskid/assets/old/pin.png'] = 'rbxasset://pin.png',
	['vapeskid/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['vapeskid/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['vapeskid/assets/old/search.png'] = 'rbxasset://search.png',
	['vapeskid/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['vapeskid/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['vapeskid/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['vapeskid/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['vapeskid/assets/old/textvape.png'] = 'rbxasset://textvape.png',
	['vapeskid/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['vapeskid/assets/old/vape.png'] = 'rbxassetid://14373395239',
	['vapeskid/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('vapeskid/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('vapeskid/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('vapeskid/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('vapeskid/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('vapeskid/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('vapeskid/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('vapeskid/profiles/'..self.Profile..self.Place..'.txt') then
		local savedata = loadJson('vapeskid/profiles/'..self.Profile..self.Place..'.txt')
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('vapeskid/assets/old/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('vapeskid/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('vapeskid/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('vapeskid/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('vapeskid/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('vapeskid/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('vapeskid/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('vapeskid/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('vapeskid/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('vapeskid/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('vapeskid/assets/old/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('vapeskid/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
VapeLogo.Image = getcustomasset('vapeskid/assets/old/textvape.png')
...
VapeLogoV4.Image = getcustomasset('vapeskid/assets/old/textv4.png')
